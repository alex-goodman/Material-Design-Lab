...
public class ContactsActivity extends AppCompatActivity {
    ...
    public void makeNewContact(MenuItem mi) {
        contacts.add(0, Contact.getRandomContact(getApplicationContext()));
        mAdapter.notifyItemInserted(0);
        Snackbar.make(rvContacts, "Contact created", Snackbar.LENGTH_LONG).setAction("UNDO", removeContact).show();
    }
